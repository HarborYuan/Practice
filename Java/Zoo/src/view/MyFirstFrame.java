...
public class MyFirstFrame extends JFrame {
	...
	public MyFirstFrame() {
		...
		button_1.addActionListener(new Handler(this));
	}
}
...
class Handler implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.frame.button) {
			String s1 = this.frame.textField.getText();
			String s2 = this.frame.textField_1.getText();
			int num,tot;
			try {
			...
			this.frame.lblNewLabel_2.setText("<html>");
			for (int i=0;i<tot;i++) {
				if (test[i]) {
					...
					this.frame.lblNewLabel_2.setText(this.frame.lblNewLabel_2.getText()+tmp+ttt+i+"<br>");
				}
			}
			this.frame.lblNewLabel_2.setText(this.frame.lblNewLabel_2.getText()+"</html>");
		}
		if (e.getSource() == this.frame.button_1) {
			this.frame.lblNewLabel_2.setText("");
		}
		
	}
	
	private MyFirstFrame frame = null;
	public Handler(MyFirstFrame frame) {
		this.frame = frame;
	}
