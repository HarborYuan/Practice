...
public class TimeOrderDialog extends JDialog {
	...
	*/
	 ...
	 * Create the dialog.
	 */
	public TimeOrderDialog(MainFrame parent, boolean notShow, int grade) {
		...
		JLabel lblNewLabel = new JLabel("\u6392\u884C\u699C"+"（"+"难度"+grade+"X"+grade+"）");
		lblNewLabel.setForeground(Color.RED);
		lblNewLabel.setFont(new Font("宋体", Font.PLAIN, 21));
		lblNewLabel.setBounds(133, 13, 180, 34);
		...
		contentPanel.add(taResult);
		{
			...
			}
			{
				...
				ArrayList<TimeOrder> al = hdb.selectInfo(grade);
				if (al.size()==0) {
